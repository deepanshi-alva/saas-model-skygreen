    ...
    <>
      ...
      <CardContent className="border-b border-default-200">
        <div className="flex gap-6  flex-col xl:flex-row">
          ...
          <div className="flex-1">
              ...
              <div className="flex justify-end gap-4 flex-wrap">
                ...
                <div className="flex flex-col">
                  ...
                  <Button
                    ...
                    variant=""
                    color={`${
                      courseStatus?.progress !== 100 ? "primary" : "success"
                    }`}
                          ...
                          <Button
                            ...
                            onClick={() => {
                              if (
                                ...
                                updateCourseEnrollmentsIsTakeAssignemtns();
                                router.push(
                                  `/take-assessment/${course?.assignments[0]?.documentId}`
                                );
                              }
                            }}
                          >
                ...
                {showCertificate && (
                  <button
                    className="text-primary mt-auto rounded-md px-4 border w-max py-3 cursor-pointer hover:underline"
            ...
            {/* Add Preview Certificate Button */}
            {/* {enrollmentStatus && (
              <div className="mt-4">
            ...
            {/* Conditionally render CertificateGenerator for preview */}
          </div>
        </div>
      </CardContent>
      ...
      {/* {showCertificatePreview && (
        <CertificateGenerator
          ...
          user={user}
          onClose={() => setShowCertificatePreview(false)} // Optional: Pass a close handler
        />
      )} */}
